...
class MenuHelper
{
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'subItems' => [
                            ['icon' => 'brand', 'name' => 'Brand', 'path' => route('brands.index'), 'roles' => ['master', 'superadmin', 'head-office']],
                            ['icon' => 'villa', 'name' => 'Villa', 'path' => route('villas.index'), 'roles' => ['master', 'superadmin', 'head-office', 'admin-sales']],
                            ['icon' => 'unit-resort', 'name' => 'Unit Resort', 'path' => route('villa-units.index'), 'roles' => ['master', 'superadmin', 'head-office', 'admin-sales']],
                            ['icon' => 'high-season', 'name' => 'Harga High Season', 'path' => route('seasonal-prices.index'), 'roles' => ['master', 'superadmin', 'head-office', 'admin-sales']],
                            ['icon' => 'addon', 'name' => 'Add-ons', 'path' => route('addons.index'), 'roles' => ['master', 'superadmin', 'head-office', 'admin-sales']],
                            ['icon' => 'voucher', 'name' => 'Voucher', 'path' => route('vouchers.index'), 'roles' => ['master', 'superadmin', 'head-office', 'admin-sales']],
                        ],
                    ],
                    [
                        'icon' => 'tables',
    ...
    public static function getIconSvg(string $iconName): string
    {
        $icons = [
            ...
            'brand' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 2.5L16.25 5.625V14.375L10 17.5L3.75 14.375V5.625L10 2.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M10 2.5V17.5" stroke="currentColor" stroke-width="1.5"/><path d="M3.75 5.625L10 8.75L16.25 5.625" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>',
            'villa' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.75 16.25H16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M5.625 16.25V8.75L10 5.625L14.375 8.75V16.25" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M8.125 16.25V12.5H11.875V16.25" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M8.75 4.375H11.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
            'unit-resort' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3.75" y="3.75" width="5" height="5" rx="1" stroke="currentColor" stroke-width="1.5"/><rect x="11.25" y="3.75" width="5" height="5" rx="1" stroke="currentColor" stroke-width="1.5"/><rect x="3.75" y="11.25" width="5" height="5" rx="1" stroke="currentColor" stroke-width="1.5"/><rect x="11.25" y="11.25" width="5" height="5" rx="1" stroke="currentColor" stroke-width="1.5"/></svg>',
            'high-season' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 2.5V5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M10 15V17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M2.5 10H5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M15 10H17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M4.69727 4.69727L6.46499 6.46499" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M13.5352 13.5352L15.3029 15.3029" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M15.3027 4.69727L13.535 6.46499" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M6.46484 13.5352L4.69712 15.3029" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="10" cy="10" r="3.125" stroke="currentColor" stroke-width="1.5"/></svg>',
            'addon' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 4.1665V15.8332" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M4.16699 10H15.8337" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><rect x="2.91699" y="2.9165" width="14.1667" height="14.1667" rx="3" stroke="currentColor" stroke-width="1.5"/></svg>',
            'voucher' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.25 5.4165H13.75C14.4404 5.4165 15 5.97615 15 6.6665V8.33317C14.0795 8.33317 13.3333 9.07936 13.3333 9.99984C13.3333 10.9203 14.0795 11.6665 15 11.6665V13.3332C15 14.0235 14.4404 14.5832 13.75 14.5832H6.25C5.55964 14.5832 5 14.0235 5 13.3332V11.6665C5.92048 11.6665 6.66667 10.9203 6.66667 9.99984C6.66667 9.07936 5.92048 8.33317 5 8.33317V6.6665C5 5.97615 5.55964 5.4165 6.25 5.4165Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M9.16699 7.9165H10.8337" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9.16699 12.0835H10.8337" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
        ];

        return $icons[$iconName] ?? $icons['pages'];
    }
}
