...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 w-[290px] -translate-x-full xl:translate-x-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-99999 border-r border-gray-200"
    x-data="{
    ...
    <!-- Navigation Menu -->
    <div id="sidebar-scroll-area" class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <nav class="mb-6">
