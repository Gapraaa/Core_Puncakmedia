...
@section('content')
    ...
    <div class="space-y-6" data-async-page="true">
        ...
        <x-common.component-card title="Filter Add-on" desc="Cari add-on berdasarkan nama, tipe charge, dan status aktif.">
            <form data-async-page-form="true" method="GET" action="{{ route('addons.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                            ...
                            <tr>
                                <td colspan="6" class="px-5 py-10">
                                    <x-common.empty-state
                                        ...
                                        description="Tambahkan add-on seperti extra bed, tambahan orang, grill, atau catering agar siap dipakai di flow booking."
                                        actionLabel="Tambah Add-on"
                                        :actionHref="route('addons.create')"
                                    />
                                </td>
                            </tr>
                        @endforelse
