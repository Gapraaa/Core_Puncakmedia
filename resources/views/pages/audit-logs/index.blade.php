...
@section('content')
    ...
    <div class="space-y-6" data-async-page="true">
        ...
        <x-common.component-card title="Filter Audit Log" desc="Cari berdasarkan user, modul, aksi, tanggal, atau kata kunci.">
            <form data-async-page-form="true" method="GET" action="{{ route('audit-logs.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-6">
                        ...
                        @forelse ($auditLogs as $auditLog)
                            <tr class="border-b border-gray-100 align-top dark:border-gray-800">
                                <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-300">
                                            <div class="font-medium text-gray-800 dark:text-white/90">{{ $auditLog->created_at?->format('j M Y') }}</div>
