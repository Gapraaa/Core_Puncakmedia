                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Gunakan username atau email internal untuk masuk ke sistem.
                            </p>
                        </div>
                        <div>
                            ...
                            <form method="POST" action="{{ route('signin.store') }}"
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="text" id="login" name="login" value="{{ old('login') }}" placeholder="mis. master atau master@puncakmedia.local"
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-xs text-gray-500 dark:text-gray-400">Hubungi Master atau Superadmin jika lupa password</span>
                                    </div>
                                    <div>
                                        <button
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-600 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-300">
                                        Akun demo: <span class="font-semibold">master</span>, <span class="font-semibold">finance</span>, <span class="font-semibold">adminsales</span>
                                        dengan password <span class="font-semibold">password</span>.
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem internal untuk pengelolaan booking, invoice, pembayaran, dan operasional villa Puncakmedia.
                        </p>
                    </div>
                </div>
            </div>
