...
@section('content')
    ...
    <div class="space-y-6" data-async-page="true">
        ...
        <x-common.component-card title="Filter Villa" desc="Cari villa berdasarkan nama, lokasi, dan tipe properti.">
            <form data-async-page-form="true" method="GET" action="{{ route('invoices.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <tr>
                                <td colspan="7" class="px-5 py-10">
                                    <x-common.empty-state
                                        ...
                                        description="Invoice akan tersedia setelah ada booking yang dibuat. Tambahkan villa dulu lalu mulai booking pertama."
