    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Pilih villa terlebih dahulu. Villa biasa langsung ke daftar harga, sedangkan resort masuk ke daftar unit dulu.</p>
            </div>
        </div>
        ...
        <x-common.component-card title="Daftar Villa" desc="Masuk ke alur pengelolaan harga high season berdasarkan struktur villa dan unit.">
                    ...
                    <tbody>
                        @forelse ($villas as $villa)
                            <tr class="border-b border-gray-100 last:border-b-0 dark:border-gray-800">
                                ...
                                <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-300">{{ $villa->high_season_count }} data</td>
