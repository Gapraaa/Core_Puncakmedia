...
@section('content')
    ...
    <div class="space-y-6" data-async-page="true">
        ...
        <x-common.component-card title="Filter Villa" desc="Cari villa berdasarkan nama, slug, lokasi, dan status.">
            <form data-async-page-form="true" method="GET" action="{{ route('villas.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <tr>
                                <td colspan="6" class="px-5 py-10">
                                    <x-common.empty-state
                                        compact
                                        title="Belum Ada Villa"
                                        description="Mulai dari input villa atau resort dulu. Setelah itu baru unit, harga, gallery, kalender, dan booking bisa dipakai penuh."
                                        actionLabel="Tambah Villa"
                                        :actionHref="route('villas.create')"
                                        secondaryActionLabel="Lihat Brand"
                                        :secondaryActionHref="route('brands.index')"
                                    />
                                </td>
                            </tr>
                        @endforelse
